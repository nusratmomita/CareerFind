    ...
    return (
        <div>
            <div className='flex gap-2 justify-center items-center'>
                ...
                {/* steps */}
                <div className="-mt-5 text-4xl font-bold flex flex-col p-30 items-center space-y-10">

                    <div className="self-start bg-blue-300 text-blue-900 px-4 py-2 rounded-2xl shadow">
                    ...
                    <div className="self-end bg-purple-300 text-purple-900 px-4 py-2 rounded-2xl shadow">
                       <h1>Upload Your CV Here___</h1>
                       <label className="text-2xl font-medium" htmlFor="myfile">Upload CV:</label>
                       <br />
                       <input className="w-[130px] lg:w-full text-2xl font-medium" type="file" id="myfile" name="myfile"></input>
                       <button type="button" className="text-white bg-[#4578f8] hover:bg-[#2557D6]/90 focus:ring-4 focus:ring-[#2557D6]/50 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 me-2 mb-2">
                    ...
                    <div className="self-end bg-purple-300 text-purple-900 px-4 py-2 rounded-2xl shadow">
                       ...
                       <p className='text-blue-800 mt-5 text-2xl font-medium'>Prepare for your interview with our mock interview feature
                        </p>
                    </div>
