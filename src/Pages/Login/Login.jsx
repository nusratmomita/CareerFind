...
const Login = () => {
  ...
  const handleLoginSubmit = (e) => {
    ...
    if(!email || !password){
      toast.error("Fill all the fields to continue")
      return
    }
    ...
    .then(() => {
      ...
      .catch(() => {
        toast.error("You have put wrong Credentials");
      });
  };
      ...
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-800 text-white mx-auto my-10">
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-12">
          ...
          <div className="space-y-2">
            ...
            <hr className="mt-5 w-full dark:text-gray-600" />
            ...
            <hr className="mt-5 mb-5 w-full dark:text-gray-600" />
