    ...
    return (
        <div className='flex justify-between gap-20 mt-15  bg-linear-to-b from-blue-900 to-indigo-100 p-10 rounded-2xl m-20'>
            ...
            <h1 className="text-5xl text-black font-extrabold">
                CareerFind<span className="text-purple-900">___</span>
            </h1>
            ...
            <p className="text-xl text-purple-900 font-semibold">
                <span className='text-2xl'>CareerFind</span> is a platform that connects job seekers with employers, providing a 
